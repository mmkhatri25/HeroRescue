...
public class HostageManager : CharsBase
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        else if (collision.gameObject.tag == Utils.TAG_LAVA || collision.gameObject.tag == Utils.TAG_LAVA || collision.gameObject.tag == "Trap_Other" || collision.gameObject.name == "arrow")
        {
